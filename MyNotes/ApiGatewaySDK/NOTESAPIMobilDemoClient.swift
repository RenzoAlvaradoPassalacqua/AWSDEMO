...
public class NOTESAPIMobilDemoClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "NOTESAPIMobilDemoClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:NOTESAPIMobilDemoClient = {
        ...
        return NOTESAPIMobilDemoClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = NOTESAPIMobilDemoClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `NOTESAPIMobilDemoClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> NOTESAPIMobilDemoClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         NOTESAPIMobilDemoClient.registerClient(withConfiguration: configuration, forKey: "USWest2NOTESAPIMobilDemoClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = NOTESAPIMobilDemoClient.client(forKey: "USWest2NOTESAPIMobilDemoClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(NOTESAPIMobilDemoClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> NOTESAPIMobilDemoClient {
		objc_sync_enter(self)
		if let client: NOTESAPIMobilDemoClient = _serviceClients.object(forKey: key) as? NOTESAPIMobilDemoClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			NOTESAPIMobilDemoClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! NOTESAPIMobilDemoClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://c550icozi9.execute-api.us-east-2.amazonaws.com/Develop"
